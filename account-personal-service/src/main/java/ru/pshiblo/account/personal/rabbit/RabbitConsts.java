package ru.pshiblo.account.personal.rabbit;
...
public class RabbitConsts {
    ...
    public final String PERSONAL_AFTER_SEND_Q = "deposit_after_send_q";
    public final String PERSONAL_CHECK_FROM_Q = "check_from_transaction_q_deposit";
    public final String PERSONAL_CHECK_TO_Q = "check_to_transaction_q_deposit";
    public final String CARD_AFTER_SEND_Q = "card_after_send_q";

    public final String PERSONAL_AFTER_SEND_ROUTE = "deposit_after_send_route";
    ...
    public final String PERSONAL_TO_CHECK_ROUTE = "deposit_to_check_route";
    public final String PERSONAL_FROM_CHECK_ROUTE = "deposit_from_check_route";
