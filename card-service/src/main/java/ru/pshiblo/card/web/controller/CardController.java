...
import ru.pshiblo.card.web.dto.request.ChangePinCardDto;
import ru.pshiblo.card.web.dto.request.CreateCardDto;
import ru.pshiblo.security.AuthUtils;
import ru.pshiblo.card.mappers.CardMapper;
        ...
        return cardMapper
                .toDto(
                        cardService.createCard(
                                cardMapper.toEntity(createCardDto),
                                createCardDto.getCurrency()
                        )
                );
    }
