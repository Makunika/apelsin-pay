...
public interface TinkoffApi {
    ...
    TinkoffInvoicingStatusResponse getStatusInvoicing(@PathVariable String id);

    @PostMapping("/api/v1/e-invoice/{id}/confirm")
    void confirmInvoicing(@RequestBody TinkoffInvoicingCancelOrConfirm request, @PathVariable String id);

    @PostMapping("/api/v1/e-invoice/{id}/cancel")
    void cancelInvoicing(@RequestBody TinkoffInvoicingCancelOrConfirm request, @PathVariable String id);
}
